  ...
  <div class="header-area" id="headerArea">
    ...
    <div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas" aria-labelledby="suhaOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <li><a href="dahsboard.php"><i class="lni lni-dashboard"></i>Dashboard</a></li>
          ...
          <li><a href="view_feedback.html"><i class="fas fa-info-circle"></i>view feedback</a></li>
    ...
    <div class="page-content-wrapper">
      <div class="top-products-area pb-5">
    <div class="row g-1" >
          <div class="container mt-1 pt-2 pb-2">
            <div class="container-fluid bg-primary text-white border-bottom py-3">
             ...
             <i class="fas fa-chart-bar" style="color: #007btf; font-size: 32px;"></i>
                 <h1 class="h4 mb-0 text-white">ADVOCATES REPORT</h1>
             </div>
         </div>
     </div>
