...
<html ng-app="myapp">
  ...
  <body   ng-controller="myappCtrl">
    ...
    <div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas" aria-labelledby="suhaOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <li><a href="dashboard.php"><i class="lni lni-dashboard"></i>Dashboard</a></li>
          <!-- <li><a href="admin_home.html"><i class="lni lni-home"></i>Home</a></li> -->
          <li><a href="view_con_details.html"><i class="lni lni-user"></i>Aprove Advocate</a></li>
          <li><a href="view_user_details.html"><i class="fas fa-exclamation-triangle"></i>user details</a></li>
          <li><a href="view_feedback.php"><i class="fas fa-info-circle"></i>view feedback</a></li>
          <li><a href="caseReport.html"><i class="fas fa-info-circle"></i>case reports</a></li>
          <li><a href="userReport.php"><i class="fas fa-info-circle"></i>user Report</a></li>
          <li><a href="advocateTest.php"><i class="fas fa-info-circle"></i>advocate Report</a></li>
    ...
    <div class="container mt-2 pt-5 pb-2">
    <div class="container-fluid bg-primary text-white border-bottom py-3">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <i class="fas fa-users fa-2x me-2"></i>
                <h1 class="h4 mb-0 text-white">ADMIN DASHBOARD</h1>
            </div>
        </div>
    </div>
    ...
    <!-- <div class="container mt-5 pt-5 pb-5">       </div> -->


    <div class="container mt-2 pt- pb-2">
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="card card-custom">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted">total advocate</h6>
                        <h3 class="advocate"></h3>
                    </div>
                    <div class="icon">
        ...
        <div class="col-md-12">
            <div class="card card-custom">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted">activeAdvocate</h6>
                        <h3 class="activeAdvocate"></h3>
                    </div>
                    <div class="icon">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted">finish cases</h6>
                        <h3 class="process"></h3>
                    </div>
                    <div class="icon">
                        <i class="fas fa-shopping-cart"></i>
...
$(document).ready(function(){
    ...
    const countRowNumbers = (tableName, label) => {
        ...
        countRowNumbers("advocate", $(".advocate"))
        countRowNumbers("user_login", $(".user"))
        countRowNumbers("problem", $(".cases"))
        ...
        countRowNumbersActive("user_login", $(".activeUsers"),'Approval',"countActive");
        countRowNumbersActive("advocate", $(".activeAdvocate"),'Approval',"countAdvocate");
