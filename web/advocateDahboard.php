    ...
    <div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas" aria-labelledby="suhaOffcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <div class="sidenav-profile">
          ...
          ?>
          <div class="user-info">
            <h6 class="user-name mt-4"><?php echo $_SESSION['ADVOCATE']?></h6>
    ...
    <div class="container-fluid bg-primary text-white border-bottom py-1">
        <div class="row align-items-center">
            <div class="col d-flex align-items-center">
                <i class="fas fa-users fa-4x me-2"></i>
                <h1 class="h4 mb-0 text-white">ADVOCATE DASHBOARD</h1>
            </div>
        </div>
    </div>
...
$(document).ready(function(){
        ...
        countRowNumbersActive("requests", $(".finish"),'Finished',"countAdvocateCases");
        countRowNumbersActive("requests", $(".pending"),'pending',"countAdvocateCases");
        countRowNumbersActive("requests", $(".reject"),'rejected',"countAdvocateCases");
        countRowNumbersActive("requests", $(".process"),'accepted',"countAdvocateCases");
        countRowNumbersActive("requests", $(".cases"),'accepted',"countCases")
